...
MIGRATION_MODULES = {
    'sites': 'ketabetojabezar.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Daniel Roy Greenfeld""", 'niloofar1376@gmail.com'),
]
...
# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ['ketabetojabezar.taskapp.celery.CeleryConfig']
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'ketabetojabezar.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'ketabetojabezar.users.adapters.SocialAccountAdapter'
